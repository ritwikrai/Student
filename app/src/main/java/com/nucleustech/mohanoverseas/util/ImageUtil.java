...
public class ImageUtil {
	...
	private static final DisplayImageOptions.Builder DEFAULT_DISPLAY_IMAGE_OPTIONS_BUIDLER = new DisplayImageOptions.Builder()
			...
			.showImageForEmptyUri(R.mipmap.ic_launcher_round).showImageOnLoading(R.mipmap.ic_launcher_round)
			.showImageOnFail(R.mipmap.ic_launcher_round).cacheOnDisk(true).cacheInMemory(true).bitmapConfig(Config.ARGB_8888);
